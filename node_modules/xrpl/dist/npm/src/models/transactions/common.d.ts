import { Amount, Currency, IssuedCurrencyAmount, Memo, Signer, XChainBridge, MPTAmount } from '../common';
...
export declare function validateCredentialsList(credentials: unknown, transactionType: string, isStringID: boolean): void;
